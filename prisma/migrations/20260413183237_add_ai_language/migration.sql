...
INSERT INTO "new_Settings" ("deckHost", "deckPassword", "deckUser", "id", "igdbClientId", "igdbClientSecret", "openrouterKey", "steamApiKey", "steamgriddbKey") SELECT "deckHost", "deckPassword", "deckUser", "id", "igdbClientId", "igdbClientSecret", "openrouterKey", "steamApiKey", "steamgriddbKey" FROM "Settings";
DROP TABLE "Settings";
